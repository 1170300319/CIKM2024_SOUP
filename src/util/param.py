...
# https://github.com/jeykigung/P5/src/params.py
...
def parse_args(parse=True, **optional_kwargs):
    ...
    # Model Config
    parser.add_argument('--path', type=str, default='./pretrained_model/t5')
    ...
    parser.add_argument('--database', type=str, default='id')
